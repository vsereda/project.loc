        ...
        @if(isset($dishes) && count($dishes))
            <div class="ubuntu-ft">
                <p>
                    ...
                    Наши супы изготовлены из натуральных, экологически чистых продуктов и соответствуют марки
                    «Органических
                    продуктов». Многие из них относятся к классу вегетарианских. При общем заказе в Ваш офис больше 10
                    изделий доставляются <strong>бесплатно</strong>. Доставка осуществляется <strong>«на
                        завтра»</strong> в
                    ...
                    </strong> Расчет осуществляется на месте в наличной и безналичной форме. Для постоянных
                    пользователей
